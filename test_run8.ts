...
async function run() {
    ...
    try {
        const task = 'Design a basic 3-component survival architecture for a Mars colony. Each specialist should contribute their part. Once all three (Life Support, Energy, Structure) parts are listed in the collective state, you MUST reply EXACTLY with SIGNAL_STABILIZATION';
